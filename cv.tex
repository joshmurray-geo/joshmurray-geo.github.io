...
\section{~~Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {PhD. Ultramafic alteration and the cooling of Earth and Mars. \vspace{5pt}}{September 2018 - August 2024}
      {\scriptsize \textit{ \small{\newline{}\textbf{Earth, Atmospheric and Planetary Sciences} ~~~Advised by Prof. Oli Jagoutz}}}
    \resumeSubheading
      {Princeton University}{Princeton, NJ}
      {A.B. A deterministic approach to geochemical stratigraphy. \vspace{5pt}}{September 2014 - June 2018}
...
\section{~~Publications}
  \resumeSubHeadingListStart
    ...
    {\\Joshua Murray, PB Kelemen, JA Leong, JF Mustard~~~~~~~ \textit{In review – preprint available upon request}}
    \resumeItem
    {Sedimentary constraints on silicate weathering during the Taconic orogeny in Newfoundland}
    {\\Joshua Murray, Oliver Jagoutz, Kristin Bergmann.~~~ \textit{In prep – preprint available upon request}}
    \resumeItem
...
\section{~~Talks and Presentations}
  \resumeSubHeadingListStart
    \resumeSubheading
    {Invited: Ophiolite weathering and the Palaeozoic carbon cycle}{}
    {University of Miami, Florida – October 2025}{} 
    \resumeSubheading
    {Subaerial carbonate formation on Mars}{}
    {Goldschmidt Conference 2025 - Prague}{} 
    \resumeSubheading
    {Invited: Palaeozoic changes in weathering and organic carbon burial}{}
    {Pennsylvania State University Geochemistry - April 2025}{} 
    \resumeSubheading
    {Carbon cycle changes during the Taconic orogeny in Newfoundland, Canada}{}
    {AGU Fall Meeting 2024 - Poster}{} 
    \resumeSubheading
    {How rocks keep Earth cool}{}
    {MIT Abstracts - December 2024}{} 
    \resumeSubheading
    {Ultramafic alteration and the cooling of Earth and Mars}{}
    {Lamont-Doherty Geodynamics Seminar - November 2024}{} 
    \resumeSubheading
...
\section{~~Honours and Awards}
  ...
  \resumeSubheading
    ...
    {Research funding (\$16,000) and support from the High Meadows Environmental Institute}{}  
  \resumeSubheading
...
\section{~~Mentoring and Service}
  \resumeSubHeadingListStart
    ...
    {One of three organisers of Lamont-Doherty's interdisciplinary Geodynamics Seminar}{} 
    \resumeSubheading
    {Reviewer}{2024–}
    {EPSL; PNAS; JGR}{}
    \resumeSubheading
  ...
  \resumeSubheading
    {Mentor - Fulbright Sutton Trust US Programme Mentor}{~~~~~~~~~2019-2024}
...
\section{~~Field Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{North Cascades, Washington}{2 weeks, August 2025}
    \resumeSubHeadingListEnd
\end{document}